...
export const mockChatMessages = [
  { id: 'm1', userId: 'f1', userName: 'NightWolf', userEmoji: '🐺', userColor: '#22D3EE', content: 'Bugün türev soruları için harika bir kaynak buldum 📚', timestamp: '10:23', reactions: [{ emoji: '👍', count: 4 }, { emoji: '🔥', count: 2 }] },
  { id: 'm2', userId: 'f2', userName: 'StarGazer', userEmoji: '⭐', userColor: '#F59E0B', content: 'Hangi kaynak? Paylaşır mısın?', timestamp: '10:24', reactions: [] },
  { id: 'm3', userId: 'f1', userName: 'NightWolf', userEmoji: '🐺', userColor: '#22D3EE', content: 'Hocalara gelen sorular kitabı, çok kaliteli. YKS için birebir', timestamp: '10:25', reactions: [{ emoji: '❤️', count: 3 }] },
  { id: 'm4', userId: 'f3', userName: 'IronMind', userEmoji: '🧠', userColor: '#A78BFA', content: '🏆 Ahmet haftalık sıralamada 1. sıraya yükseldi!', timestamp: '10:30', isSystem: true, reactions: [] },
  { id: 'm5', userId: 'u1', userName: 'Shadow Fox', userEmoji: '🦊', userColor: '#7B5CF5', content: 'Tebrikler! Ben de bugün 4 saat çalıştım, hedefe yaklaşıyorum', timestamp: '10:31', reactions: [{ emoji: '💪', count: 2 }] },
  { id: 'm6', userId: 'f4', userName: 'DawnRider', userEmoji: '🌅', userColor: '#10B981', content: 'Kimya organik kısmını bitirdim sonunda! Bu hafta fizik var', timestamp: '10:45', reactions: [{ emoji: '✅', count: 5 }] },
  { id: 'm7', userId: 'f2', userName: 'StarGazer', userEmoji: '⭐', userColor: '#F59E0B', content: 'Türev + integral kombo çalışması yapalım mı akşam? Rando ile', timestamp: '11:00', reactions: [{ emoji: '👍', count: 3 }, { emoji: '🔥', count: 1 }] },
  { id: 'm8', userId: 'u1', userName: 'Shadow Fox', userEmoji: '🦊', userColor: '#7B5CF5', content: 'Ben varım! Akşam 8 olur mu?', timestamp: '11:02', reactions: [] },
];
