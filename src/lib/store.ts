...
import { TIMER_MODES, POMODORO_COUNT, XP_PER_MINUTE, LP_PER_MINUTE, RANK_TIERS, SUBJECTS } from './constants';
...
export const useStore = create<StoreState>((set, get) => ({
  ...
  subjectDistribution: [...mockSubjectDistribution],
