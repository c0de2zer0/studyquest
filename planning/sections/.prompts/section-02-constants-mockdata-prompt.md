...
Generate content for section `section-02-constants-mockdata` (filename: `section-02-constants-mockdata.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/behlul/studyquest/planning/claude-plan.md` - Full implementation plan
2. `/home/behlul/studyquest/planning/claude-plan-tdd.md` - Test stubs for each section
3. `/home/behlul/studyquest/planning/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-02-constants-mockdata` to understand what this section should contain.
...
`/home/behlul/studyquest/planning/sections/section-02-constants-mockdata.md`
