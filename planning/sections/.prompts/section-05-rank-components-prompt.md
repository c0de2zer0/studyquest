...
Generate content for section `section-05-rank-components` (filename: `section-05-rank-components.md`).
...
for `section-05-rank-components` to understand what this section should contain.
...
`/home/behlul/studyquest/planning/sections/section-05-rank-components.md`
