...
Generate content for section `section-09-community` (filename: `section-09-community.md`).
...
for `section-09-community` to understand what this section should contain.
...
`/home/behlul/studyquest/planning/sections/section-09-community.md`
