...
Generate content for section `section-01-store` (filename: `section-01-store.md`).
...
for `section-01-store` to understand what this section should contain.
...
`/home/behlul/studyquest/planning/sections/section-01-store.md`
