...
Generate content for section `section-07-avatar-screen` (filename: `section-07-avatar-screen.md`).
...
for `section-07-avatar-screen` to understand what this section should contain.
...
`/home/behlul/studyquest/planning/sections/section-07-avatar-screen.md`
