...
Generate content for section `section-04-pixel-avatar` (filename: `section-04-pixel-avatar.md`).
...
for `section-04-pixel-avatar` to understand what this section should contain.
...
`/home/behlul/studyquest/planning/sections/section-04-pixel-avatar.md`
