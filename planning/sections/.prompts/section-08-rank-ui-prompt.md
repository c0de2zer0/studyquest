...
Generate content for section `section-08-rank-ui` (filename: `section-08-rank-ui.md`).
...
for `section-08-rank-ui` to understand what this section should contain.
...
`/home/behlul/studyquest/planning/sections/section-08-rank-ui.md`
