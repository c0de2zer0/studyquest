...
Generate content for section `section-03-avatar-layers` (filename: `section-03-avatar-layers.md`).
...
for `section-03-avatar-layers` to understand what this section should contain.
...
`/home/behlul/studyquest/planning/sections/section-03-avatar-layers.md`
