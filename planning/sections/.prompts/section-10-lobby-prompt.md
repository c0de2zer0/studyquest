...
Generate content for section `section-10-lobby` (filename: `section-10-lobby.md`).
...
for `section-10-lobby` to understand what this section should contain.
...
`/home/behlul/studyquest/planning/sections/section-10-lobby.md`
